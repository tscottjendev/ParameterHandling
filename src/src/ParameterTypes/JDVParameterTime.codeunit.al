codeunit 80011 "JDV Parameter - Time" implements "JDV Parameter Handler"
{
    /// <summary>
    /// Provides a time parameter instance.
    /// </summary>
    ...
    begin
        ValueVariant := JDVParameterTypeConverter.ConvertToTime(Format(ValueVariant));
    end;
