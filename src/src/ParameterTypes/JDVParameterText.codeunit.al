codeunit 80010 "JDV Parameter - Text" implements "JDV Parameter Handler"
{
    /// <summary>
    /// Provides a text parameter instance.
    /// </summary>
    ...
    begin
        ValueVariant := JDVParameterMgt.ConvertToText(Format(ValueVariant));
    end;
