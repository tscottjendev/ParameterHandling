codeunit 80005 "JDV Parameter - DateFormula" implements "JDV Parameter Handler"
{
    /// <summary>
    /// Provides a dateformula parameter instance.
    /// </summary>
    var
        Required: Boolean;
    ...
    begin
        ValueVariant := JDVParamTypeConverter.ConvertToDateFormula(Format(ValueVariant));
    end;
