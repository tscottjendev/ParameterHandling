codeunit 80006 "JDV Parameter - DateTime" implements "JDV Parameter Handler"
{
    /// <summary>
    /// Provides a datetime parameter instance.
    /// </summary>
    var
        Required: Boolean;
    ...
    begin
        ValueVariant := JDVParameterTypeConverter.ConvertToDateTime(Format(ValueVariant));
    end;
