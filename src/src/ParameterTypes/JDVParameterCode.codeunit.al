codeunit 80003 "JDV Parameter - Code" implements "JDV Parameter Handler"
{
    /// <summary>
    /// Provides a code parameter instance.
    /// </summary>
    ...
    begin
        ValueVariant := JDVParameterTypeConverter.ConvertToCode(Format(ValueVariant));
    end;
